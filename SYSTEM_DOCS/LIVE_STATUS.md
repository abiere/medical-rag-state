...
> Last update: **2026-04-15 22:54:54 UTC**
...
| Metric | Value |
|---|---|
| Current job | `969553977-Trail-Guide-to-the-Body-6th-Edition-Andrew-Biel.pdf` (28 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Lower_Body_Techniques.mp4` (408 min) |
| Queued | 20 |
| Done | 15 / 35 |
...
| Uptime | up 1 day, 13 hours, 12 minutes |
