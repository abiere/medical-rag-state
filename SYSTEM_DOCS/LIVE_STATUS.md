...
> Last update: **2026-04-17 18:52:11 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Sobotta Atlas of Anatomy, Vol.1, 17th ed., English_Latin_ General anatomy and Musculoskeletal System_nodrm.epub` (6 min) |
| Queued | 4 |
| Total books | 64 |
| Ingested | 50 |
...
| Metric | Value |
|---|---|
| RAM used | 14.34 GB / 32.86 GB (44%) |
| CPU | 99.9% |
| Disk used | 67.1 GB / 322.3 GB (22%) |
| Uptime | up 13 hours, 16 minutes |
