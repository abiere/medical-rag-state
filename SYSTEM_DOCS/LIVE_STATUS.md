...
> Last update: **2026-04-17 15:18:33 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Quantum-Touch_ The Power to Heal_nodrm.epub` (4 min) |
| Queued | 3 |
| Total books | 57 |
| Ingested | 44 |
...
| Metric | Value |
|---|---|
| RAM used | 14.28 GB / 32.86 GB (44%) |
| CPU | 100.0% |
| Disk used | 62.1 GB / 322.3 GB (20%) |
| Uptime | up 9 hours, 43 minutes |
