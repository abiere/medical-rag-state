...
> Last update: **2026-04-17 15:37:08 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Sobotta Anatomy Textbook_nodrm.epub` (13 min) |
| Queued | 9 |
| Total books | 64 |
| Ingested | 45 |
...
| Metric | Value |
|---|---|
| Current job | `2021_Demos_Finding_and_Fixing_the_Glitch__Sports_Specific_Reset__and_Advanced_SC.mp4` (30 min) |
| Queued | 14 |
| Done | 21 / 37 |
