...
> Last update: **2026-04-16 05:10:06 UTC**
...
| Metric | Value |
|---|---|
| Current job | `969553977-Trail-Guide-to-the-Body-6th-Edition-Andrew-Biel.pdf` (29 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (334 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
| Uptime | up 1 day, 19 hours, 27 minutes |
