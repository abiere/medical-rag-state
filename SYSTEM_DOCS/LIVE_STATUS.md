...
> Last update: **2026-04-15 21:13:54 UTC**
...
| Metric | Value |
|---|---|
| Current job | `969553977-Trail-Guide-to-the-Body-6th-Edition-Andrew-Biel.pdf` (21 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Lower_Body_Techniques.mp4` (307 min) |
| Queued | 20 |
| Done | 15 / 35 |
...
| Uptime | up 1 day, 11 hours, 31 minutes |
