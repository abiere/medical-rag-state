...
> Last update: **2026-04-18 06:52:26 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Orthopedic Physical Assessment 7e editie - Magee, Manske.epub` (38 min) |
| Queued | 11 |
| Total books | 37 |
| Ingested | 73 |
...
| Metric | Value |
|---|---|
| RAM used | 9.59 GB / 32.86 GB (29%) |
| CPU | 99.8% |
| Disk used | 74.0 GB / 322.3 GB (24%) |
| Uptime | up 1 day, 1 hour, 17 minutes |
