...
> Last update: **2026-04-16 20:12:31 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Warnings and Cautions - Recharge Health.pdf` (1 min) |
| Queued | 26 |
| Total books | 43 |
| Ingested | 13 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (1237 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
2026-04-16 20:11:47,733  INFO      Queue paused (pause flag set) — waiting 30s
2026-04-16 20:12:17,733  INFO      Queue paused (pause flag set) — waiting 30s
```
