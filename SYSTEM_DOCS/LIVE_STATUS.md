...
> Last update: **2026-04-17 21:27:14 UTC**
...
| Metric | Value |
|---|---|
| Current job | `An Introduction to Craniosacral Therapy - Kern.pdf` |
| Queued | 13 |
| Total books | 37 |
| Ingested | 60 |
...
| Metric | Value |
|---|---|
| RAM used | 9.78 GB / 32.86 GB (30%) |
| CPU | 98.9% |
| Disk used | 68.8 GB / 322.3 GB (22%) |
| Uptime | up 15 hours, 51 minutes |
