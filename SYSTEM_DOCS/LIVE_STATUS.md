...
> Last update: **2026-04-16 10:34:58 UTC**
...
| Metric | Value |
|---|---|
| Current job | `359609833-Travell-and-Simons-Myofascial-Pain-and-Dysfunction-Vol-1-2nd-Ed-D-Simons-Et-Al-Williams-and-Wilkins-1999-WW.pdf` (62 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (659 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
2026-04-16 10:31:42,287  INFO      Queue paused (pause flag set) — waiting 30s
