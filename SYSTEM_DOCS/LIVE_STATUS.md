...
> Last update: **2026-04-16 01:24:54 UTC**
...
| Metric | Value |
|---|---|
| Current job | `359609833-Travell-and-Simons-Myofascial-Pain-and-Dysfunction-Vol-1-2nd-Ed-D-Simons-Et-Al-Williams-and-Wilkins-1999-WW.pdf` (23 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (109 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
| Metric | Value |
|---|---|
| RAM used | 15.77 GB / 32.86 GB (48%) |
| CPU | 92.4% |
| Disk used | 54.3 GB / 322.3 GB (18%) |
| Uptime | up 1 day, 15 hours, 42 minutes |
