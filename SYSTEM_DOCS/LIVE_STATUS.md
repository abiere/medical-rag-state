...
> Last update: **2026-04-18 06:27:26 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Orthopedic Physical Assessment 7e editie - Magee, Manske.epub` (13 min) |
| Queued | 11 |
| Total books | 37 |
| Ingested | 72 |
...
| Metric | Value |
|---|---|
| RAM used | 15.16 GB / 32.86 GB (46%) |
| CPU | 98.0% |
| Disk used | 73.6 GB / 322.3 GB (24%) |
| Uptime | up 1 day, 52 minutes |
