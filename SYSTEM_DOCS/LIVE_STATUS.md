...
> Last update: **2026-04-17 15:17:08 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Quantum-Touch_ The Power to Heal_nodrm.epub` (3 min) |
| Queued | 3 |
| Total books | 57 |
| Ingested | 44 |
...
| Metric | Value |
|---|---|
| Current job | `2021_Demos_Finding_and_Fixing_the_Glitch__Sports_Specific_Reset__and_Advanced_SC.mp4` (10 min) |
| Queued | 14 |
| Done | 21 / 37 |
