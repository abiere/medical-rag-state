...
> Last update: **2026-04-16 00:51:35 UTC**
...
| Metric | Value |
|---|---|
| Current job | `pdfcoffee.com_a-manual-of-acupuncture-peter-deadmanpdf-4-pdf-free.pdf` (20 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (76 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
| Metric | Value |
|---|---|
| RAM used | 15.29 GB / 32.86 GB (46%) |
| CPU | 99.9% |
| Disk used | 54.3 GB / 322.3 GB (18%) |
| Uptime | up 1 day, 15 hours, 8 minutes |
