...
> Last update: **2026-04-17 17:20:32 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Sobotta Atlas of Anatomy, Vol. 2, 17th ed., English_Latin_ Internal Organs_nodrm.epub` (17 min) |
| Queued | 7 |
| Total books | 64 |
| Ingested | 47 |
...
| Metric | Value |
|---|---|
| Current job | `2021_Demos_Finding_and_Fixing_the_Glitch__Sports_Specific_Reset__and_Advanced_SC.mp4` (9 min) |
| Queued | 14 |
| Done | 21 / 37 |
...
2026-04-17 17:11:10,523  INFO      ────────────────────────────────────────────────────────────
2026-04-17 17:11:10,523  INFO      Transcription queue manager started
