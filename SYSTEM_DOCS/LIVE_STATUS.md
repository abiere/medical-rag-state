...
> Last update: **2026-04-17 22:27:15 UTC**
...
| Metric | Value |
|---|---|
| Current job | `Bates Guide to Physical Examination 14e editie - Bickley.epub` (18 min) |
| Queued | 11 |
| Total books | 37 |
| Ingested | 63 |
...
| Metric | Value |
|---|---|
| RAM used | 9.62 GB / 32.86 GB (29%) |
| CPU | 99.4% |
| Disk used | 69.7 GB / 322.3 GB (22%) |
| Uptime | up 16 hours, 51 minutes |
