...
> Last update: **2026-04-16 02:55:24 UTC**
...
| Metric | Value |
|---|---|
| Current job | `359609833-Travell-and-Simons-Myofascial-Pain-and-Dysfunction-Vol-1-2nd-Ed-D-Simons-Et-Al-Williams-and-Wilkins-1999-WW.pdf` (20 min) |
| Queued | 2 |
| Total books | 3 |
| Ingested | 1 |
...
| Metric | Value |
|---|---|
| Current job | `1.Upper_Body_Techniques.mp4` (199 min) |
| Queued | 19 |
| Done | 16 / 35 |
...
| Metric | Value |
|---|---|
| RAM used | 16.0 GB / 32.86 GB (49%) |
| CPU | 98.3% |
| Disk used | 54.3 GB / 322.3 GB (18%) |
| Uptime | up 1 day, 17 hours, 12 minutes |
