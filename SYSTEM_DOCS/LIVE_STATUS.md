...
> Last update: **2026-04-18 00:17:18 UTC**
...
| Metric | Value |
|---|---|
| Current job | `dokumen.pub_atlas-of-acupuncture-1nbsped-0443100284-9780443100284.pdf` (35 min) |
| Queued | 9 |
| Total books | 37 |
| Ingested | 64 |
...
| Metric | Value |
|---|---|
| RAM used | 15.59 GB / 32.86 GB (48%) |
| CPU | 100.0% |
| Disk used | 70.3 GB / 322.3 GB (23%) |
| Uptime | up 18 hours, 41 minutes |
